...
# plot_med_quarts(Ξ_sindy_lasso_err, Ξ_gpsindy_err, noise_vec)
plot_med_quarts_sindy_nn_gpsindy(Ξ_sindy_lasso_err, Ξ_nn_err, Ξ_gpsindy_err, noise_vec, "Ξ error" )
...
plot_med_quarts_sindy_nn_gpsindy(x_sindy_lasso_err, x_nn_err, x_gpsindy_err, noise_vec, "x error")
